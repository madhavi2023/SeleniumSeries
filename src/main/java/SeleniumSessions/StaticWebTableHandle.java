...
public class StaticWebTableHandle {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		System.out.println("-----2nd column elements-----");
		String afterXpath2 = "]/td[2]";
		
		for (int row=2;row<=7;row++) {
			String tablexpath2= beforeXpath+row+afterXpath2;
			String val= driver.findElement(By.xpath(tablexpath2)).getText();
			System.out.println(val);
		}
		...
		for(int row=2;row<=7;row++) {
		String tablexpath3= beforeXpath + row + afterXpath3;
		String val= driver.findElement(By.xpath(tablexpath3)).getText();
		System.out.println(val);
	}
	}
